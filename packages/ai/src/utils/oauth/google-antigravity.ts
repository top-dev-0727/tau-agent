...
const CLIENT_ID = process.env.TAU_GOOGLE_ANTIGRAVITY_CLIENT_ID ?? "";
const CLIENT_SECRET = process.env.TAU_GOOGLE_ANTIGRAVITY_CLIENT_SECRET ?? "";
...
function requireClientCredentials(): void {
	if (!CLIENT_ID || !CLIENT_SECRET) {
		throw new Error(
			"Google Antigravity OAuth requires TAU_GOOGLE_ANTIGRAVITY_CLIENT_ID and TAU_GOOGLE_ANTIGRAVITY_CLIENT_SECRET",
		);
	}
}
